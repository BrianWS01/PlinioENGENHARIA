...
// Log de sucesso
console.log(`✅ Catálogo de produtos carregado! Total: ${Object.keys(catalogoProdutos).length} produtos`);
console.log(`   - Transformadores a Óleo: ${produtosOleo.length * 3}`);
console.log(`   - Autotransformadores: ${produtosAuto.reduce((sum, item) => sum + item.tensoes.length, 0)}`);
console.log(`   - Transformadores Isoladores: ${produtosIsolador.length}`);
